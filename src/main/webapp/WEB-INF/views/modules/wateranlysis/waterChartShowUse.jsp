...
<script type="text/javascript">
    ...
    switch (${waterData.type}) {

        case 1:
            $("#inDate").remove();

            var input_dom = "<input type='text' class='Wdate' id='inDate' onclick='WdatePicker({skin:" + "\"whyGreen\"" + ",dateFmt: \"yyyy\",maxDate:\"%y-%M-%d\"})' value='${inDate}' />";

            $("#dateCondition").prepend(input_dom);

            break;
        case 2:
            $("#inDate").remove();
            var input_dom = "<input type='text' class='Wdate' id='inDate' onclick='WdatePicker({skin:" + "\"whyGreen\"" + ",dateFmt: \"yyyy-MM\",maxDate:\"%y-%M-%d\"})' value='${inDate}' />";

            $("#dateCondition").prepend(input_dom);
            break;
        case 3:
            $("#inDate").remove();
            var input_dom = "<input type='text' class='Wdate' id='inDate' onclick='WdatePicker({skin:" + "\"whyGreen\"" + ",dateFmt: \"yyyy-MM-dd\",maxDate:\"%y-%M-%d\"})' value='${inDate}'/>";
        ...
        case 4:
            $("#inDate").remove();
            var input_dom = "<input type='date' class='Wdate' id='inDate' onclick='WdatePicker({skin:" + "\"whyGreen\"" + ",dateFmt: \"yyyy-MM-dd\",maxDate:\"%y-%M-%d\"})' value='${inDate}' />";
