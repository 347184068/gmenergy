...
<head>
    ...
    <script type="text/javascript">
        function findEchart() {
            ...
            $.post("${ctx}/energyelecyear/energyElecYear/getElecYearChart",
    ...
    <ul class="ul-form">
        ...
        <li><label>选择日期：</label>
            <input id="dataTime" name="dataTime" type="text" maxlength="20" class="input-medium Wdate"
                   value="<fmt:formatDate value="${not empty energyElecYear.dataTime ? energyElecYear.dataTime:now}" pattern="yyyy"/>"
