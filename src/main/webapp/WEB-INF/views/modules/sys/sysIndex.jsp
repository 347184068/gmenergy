...
<head>
    ...
    <style type="text/css">
		...
		.nav-list .active .weui-list-menu2, .nav-list .active .weui-label2 {
		    color: #fff;
		}
		.navbar .nav>li>a{
			text-shadow:none;
        ...
        .weui-list-menu1, .weui-list-menu2 {
            float: left;
        }
                ...
                <ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
                    ...
                    <c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
                        <c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
                            <li class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}">
                                <c:if test="${empty menu.href}">
                                    <a class="menu" href="javascript:"
                                       ...
                                       data-id="${menu.id}">
                                        <i class="icon-${not empty menu.icon ? menu.icon : 'circle-arrow-right'}"
                                                style="font-size:35px;margin-left:13px"></i>
                                        <br>
                            ...
                            <c:set var="firstMenu" value="ture"/>
                        </c:if>
                    </c:forEach>
                </ul>
            </div><!--/.nav-collapse -->
