...
<head>
	...
	<style type="text/css">
		...
		.form-search .ul-form2 li.btns .btn{margin-right:5px;}
		 #ele{float: left;width: 400px;}
		 #charge{float: left;width: 400px;margin-left: 200px;}
	</style>
	<script type="text/javascript">
		function getChart(){
			...
			$("#searchForm").attr('action',"${ctx}/water/charge/getAllDeviceChartInfo");
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
	<thead>
	<tr>
		<th>序号</th><th>月份</th><th>名称</th><th>耗水量</th><th>总水费(元)</th>
	</tr>
	</thead>
	<tbody>
	<c:choose>
