...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/expertdb/contrastDataAmount/">对比分析完成列表</a></li>
		<li class="active"><a href="${ctx}/expertdb/contrastDataAmount/form?id=${contrastDataAmount.id}">对比分析完成<shiro:hasPermission name="expertdb:contrastDataAmount:edit">${not empty contrastDataAmount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="expertdb:contrastDataAmount:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
