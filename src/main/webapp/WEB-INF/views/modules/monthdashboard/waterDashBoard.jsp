...
<head>
    ...
    <script type="text/javascript">
        ...
        function findEchart(){
            ...
            $.post("${ctx}/water/dashboard/sumMonthWater",{deviceId:deviceId,inDate:inDate,type:'${waterData.type}'},function(result){
...
<body>
<form:form id="queryByDate" modelAttribute="waterData" action="" method="post" cssStyle="margin:0 0 10px;">
