 ...
 */
package com.tp.ems.modules.energycharge.service;

import com.github.abel533.echarts.json.GsonOption;
import com.tp.ems.common.persistence.Page;
import com.tp.ems.common.service.CrudService;
import com.tp.ems.modules.energycharge.dao.EnergyChargeDao;
...
public class EnergyChargeService extends CrudService<EnergyChargeDao, EnergyCharge> {
	@Autowired
	private EnergyChargeDao energyChargeDao;
	@Autowired
	private EnergyChargeUtil util;
	 ...
	 * @return
	 */
	public Map<String,Object> getOneDeviceElecBar(EnergyCharge energyCharge){
	 ...
	 * @return
	 */
	public Map<String,Object> getDiffDeviceElecBar(Map<String,Object> map,List<String> paramIds){
	 ...
	 * @return
	 */
	public Map<String,Object> getAllDeviceElecBar(EnergyCharge energyCharge){
