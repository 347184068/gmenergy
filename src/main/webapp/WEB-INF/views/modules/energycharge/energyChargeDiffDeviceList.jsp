...
<head>
	...
	<script type="text/javascript">
		function getChart(){
			...
			$("#searchForm").attr('action',"${ctx}/energycharge/energyCharge/getDiffDeviceChartInfo");
	...
	<ul class="ul-form2">
		<li>
			...
			<sys:treeselect id="device" name="deviceId" value="${energyCharge.deviceId}" labelName="dataAmount.deviceId" labelValue="${deviceName}"
							title="监测点" url="/power/analysis/treeData?menu=elec" cssClass="input-small" allowClear="true" checked="true"/>
		</li>
		<li>&nbsp;&nbsp;&nbsp;开始时间点：
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
	<thead>
	<tr>
		<th>序号</th><th>监测点</th><th>总电量(kWh)</th><th>总电费(元)</th>
	</tr>
	</thead>
	<tbody>
	<c:choose>
	...
	<c:forEach items="${list}" var="energyCharge" varStatus="status">
		<tr>
			...
			<td>${energyCharge.electricity}</td>
