...
<head>
	...
	<script type="text/javascript">
		...
		function getChart(type){
			...
			$("#searchForm").attr('action',"${ctx}/water/expertdb/getOneDeviceEwoIntervalChart?type="+type);
		...
		function setHref(type){
			...
			var link = "${ctx}/water/expertdb/getOneDeviceEwoIntervalChart?type="
...
<ul class="nav nav-tabs">
	<li class="active" id="load_li">
		<a onclick="return setHref(1)" href="" id="load">净累计流量</a>
	</li>
	<li id="elec_li">
		<a onclick="return  setHref(2)" href="" id="elec">瞬时流量</a>
	</li>
</ul>
...
<div id="contentTable" class="table table-striped table-bordered table-condensed" style="width: 98%;">
	<div id="contentChart" style="height: 480px"></div>
	<div id="content_Contrast" style="height:480px"></div>
</div>
...
<script type="text/javascript">
	...
	if(option!=0 ){
		...
		document.getElementById("contentChart").innerHTML="选择的区间当前没有数据";
	}

	var option_contrast = ${option_compare};
	if(option_contrast!=0 ){
		...
		document.getElementById("content_Contrast").innerHTML="选择的对比区间当前没有数据";
	}
