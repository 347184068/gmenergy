            ...
            */
            ...
            $.fn.jerichoTab = {
                ...
                addTab: function(tabsetting) {
                    ...
                    */
                    var newTab = $('<li name="'+ps.name+'" class="jericho_tabs tab_selected"  id="jerichotab_' + curIndex + '" dataType="' + ps.data.dataType + '" dataLink="' + ps.data.dataLink + '">' +
                            '<div class="tab_left"  style="width:' + (opts.tabWidth - 5) + 'px"  >' +
                                (ps.iconImg == '' ? '' : '<div class="tab_icon" >&nbsp;</div>') +
