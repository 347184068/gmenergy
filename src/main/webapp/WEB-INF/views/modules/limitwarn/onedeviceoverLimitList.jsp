...
<head>
	...
	<script type="text/javascript">
		function getChart(){
			...
			$("#searchForm").attr('action',"${ctx}/limitwarn/overLimit/getOneDeviceOverLimitByCondition?menu=${menu}");
	...
	<ul class="ul-form2">
		<li>
			...
			<sys:treeselect id="device" name="deviceId" value="${overLimit.deviceId}"
							...
							title="监测点" url="/power/analysis/treeData?menu=${menu}" cssClass="input-small" allowClear="true"/>
		</li>
		<li>&nbsp;&nbsp;&nbsp;开始时间点：
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<th>标准值</th><th>下限百分比</th>
		<th>上限百分比</th><th>越限值</th>
	</tr>
	</thead>
	<tbody>
	<c:choose>
