...
<form:form id="searchForm"  modelAttribute="contrastDataAmount"    class="breadcrumb form-search ">
	<ul class="ul-form2">
		<li>
			<label>对比类型</label>
...
<div id="treeTable" class="table table-striped table-bordered table-condensed" style="width: 98%">
	<div id="treeTableList" style="height:480px">当前没有数据</div>
</div>
...
function getChart(){
	...
	if(validateCondition(deviceId,startTime,endTime)==false){
		...
		$.post("${ctx}/expertdb/contrastDataAmount/getSameDeviceChart",{deviceId:deviceId,compareType:compareType,startTime:startTime,endTime:endTime},
				function(result){
