...
<head>
    ...
    <script type="text/javascript">
        function findEchart() {
            ...
            $.post("${ctx}/energywateryear/energyWaterYear/getWaterYearChart",
                    {deviceId: deviceId, selectYear: dataTime},
                    function (result) {
...
<body>
<form:form id="searchForm" modelAttribute="energyWaterYear" class="breadcrumb form-search">
    <ul class="ul-form">
        <li><label>监测点：</label>
        ...
        <li><label>选择日期：</label>
            <input id="dataTime" name="selectYear" type="text" maxlength="20" class="input-medium Wdate"
                   value="<fmt:formatDate value="${not empty energyWaterYear.selectYear ? energyWaterYear.selectYear:now}" pattern="yyyy"/>"
